            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Vui lòng nhấn vào liên kết bên dưới để xác thực tài khoản của bạn.</p>
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                <a href="{{ $verificationUrl }}" target="_blank"
                                                   style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Xác thực ngay</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
...
{{--                            browser:</p>--}}
{{--                        <p style="margin: 0;"><a href="https://blogdesire.com" target="_blank">https://blogdesire.com/xxx-xxx-xxxx</a>--}}
{{--                        </p>--}}
{{--                    </td>--}}
{{--                </tr>--}}
                <!-- end copy -->
